...
public class PlacementManager : MonoBehaviour, IPlacementManager
{
    ...
    {
 Vector3 cameraOffs = new Vector3(1.8f,0.1f,2.0f);
        GameObject newStrcuture = Instantiate(buildingPrefab, ground.position + gridPosition + cameraOffs, Quaternion.identity);
